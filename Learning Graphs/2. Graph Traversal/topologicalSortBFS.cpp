...
5. If count of visited nodes is not equal to the number of nodes in the graph then the topological sort not possible for given graph.
...
*/
    ...
    cout << "\n\n Topological Sort = ";
    vector<int> topo = topologicalBFS(graph);
    for(int x : topo)
        cout << x << " ";

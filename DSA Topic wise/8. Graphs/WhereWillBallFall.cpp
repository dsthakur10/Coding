...
We drop one ball at the top of each column of box. Each ball can get stuck in the box or fall out of the bottom.
...
// result[i] = j --> column[j] from which ball[i] has fall out of grid
// result[i] = -1 --> ball[i] gets stuck
